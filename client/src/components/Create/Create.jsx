...
export default function Create() {
  ...
  return (
    <div className={Styles.caja}>
      {!created ? (
        <div>
          <h1 className={Styles.titlecre}>Create your game cover</h1>
          <Link to={"/home"}>
            <button className={Styles.buttonBackCreate}>Back</button>
          </Link>
          ...
          <div className={Styles.preButton}>
            <button
              ...
              className={Styles.buttonBackCreate}
              type="submit"
            >
              CREATE
            </button>
        ...
        <div className={Styles.alerthome}>
          <div className={Styles.alert}>
            <p>Your video game cover has been created.</p>
